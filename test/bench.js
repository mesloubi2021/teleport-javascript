...
run('flatted', flatted.parse, r)
console.log('-----------------------------------')
run('teleport-javascript', TJS.stringify, dummy100)
run('teleport-javascript', TJS.parse, r)
run('teleport-javascript', TJS.stringify, dummy50)
run('teleport-javascript', TJS.parse, r)
run('teleport-javascript', TJS.stringify, dummy10)
run('teleport-javascript', TJS.parse, r)
console.log('-----------------------------------')
...
run('flatted', flatted.parse, r)
run('teleport-javascript', TJS.stringify, cirular)
run('teleport-javascript', TJS.parse, r)
